package com.example.techmaster.multithread_message;
    ...
    private void initVariables(){
        ...
        handler = new Handler(){
            ...
            public void handleMessage(Message msg){
                ...
                String returedValue = (String) msg.obj;
                tvMsgReturned.setText(getString(R.string.returned_by_bg_thread) + returedValue);
